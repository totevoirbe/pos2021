...
public class ModelMakerForTest {
	...
	public static ProductModel productMock(Long identifier, ItemModel item) {
		...
		Integer mini = new Integer(identifier.intValue()) + 1;
		Integer normal = new Integer(identifier.intValue()) + 2;
		Integer geant = new Integer(identifier.intValue()) + 3;
		Integer fitmini = new Integer(identifier.intValue()) + 4;
		Integer fitnormal = new Integer(identifier.intValue()) + 5;
		Integer fitgeant = new Integer(identifier.intValue()) + 6;
