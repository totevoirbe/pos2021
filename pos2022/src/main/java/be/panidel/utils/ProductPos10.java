...
public class ProductPos10 {
	...
	public ProductPos10(String id, String code, String nom, String description, String htmlKeyLabel,
			BigDecimal prixachat, BigDecimal prix, Integer tvaTakeAway, Integer tvaTakeOnPlace, String group,
			List<SubproductPos10> subproducts) {
		super();
		this.id = id;
		this.code = code;
